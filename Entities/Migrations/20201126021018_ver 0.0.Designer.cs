...
namespace Entities.Migrations
{
    ...
    [Migration("20201126021018_ver 0.0")]
    partial class ver00
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Location.Address", b =>
                {
            ...
            modelBuilder.Entity("Entity.Location.City", b =>
                {
                    b.Property<int>("CityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.Location.Districts", b =>
                {
            ...
            modelBuilder.Entity("Entity.Location.Address", b =>
                {
                    b.HasOne("Entity.Location.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId");

                    b.HasOne("Entity.Location.Districts", "Districts")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity.User.UserModel", b =>
                {
                    b.HasOne("Entity.Location.Address", "Address")
                        .WithMany()
